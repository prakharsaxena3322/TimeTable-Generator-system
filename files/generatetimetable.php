...
<form action="generatetimetable.php" method="post">
    <div align="center" style="margin-top: 30px">
        <select name="select_teacher" class="list-group-item">
            ...
            <?php
            $q = mysqli_query(mysqli_connect("localhost", "root", "password", "ttms"),
        ...
        <table border="2" cellspacing="3" align="center" id="timetable">
            <caption><strong><br><br>
                    ...
                    if (isset($_POST['select_semester'])) {
                        ...
                        $r = mysqli_fetch_assoc(mysqli_query(mysqli_connect("localhost", "root", "password", "ttms"), "SELECT * from classrooms
                        WHERE status = '$year'"));
                        echo " ( " . $r['name'], " ) ";
                    } else if (isset($_POST['select_teacher'])) {
                        $id = $_POST['select_teacher'];
                        $r = mysqli_fetch_assoc(mysqli_query(mysqli_connect("localhost", "root", "password", "ttms"), "SELECT * from teachers
            ...
            <td style="text-align:center"><b>9:00-9:55</b></td>
            <td style="text-align:center"><b>10:00-10:55</b></td>
            <td style="text-align:center"><b>11:00-11:55</b></td>
            <td style="text-align:center"><b>12:00-12:55</b></td>
            <td style="text-align:center"><b>01:00-01:55</b></td>
            <td style="text-align:center"><b>02:00-02:55</b></td>
            <td style="text-align:center"><b>03:00-5:00</b></td>
            </tr>
            <tr>
                <?php
                $table = null;
                ...
                if (isset($_POST['select_semester']) || isset($_POST['select_teacher']) || isset($_GET['display'])) {
                    $q = mysqli_query(mysqli_connect("localhost", "root", "password", "ttms"),
                        "SELECT * FROM" . $table);
                    $qq = mysqli_query(mysqli_connect("localhost", "root", "password", "ttms"),
                        ...
                        while ($r = mysqli_fetch_assoc($qq)) {
                            if ($r['isAlloted'] == 1 && $r['semester'] == $_POST['select_semester']) {
                                ...
                                if (isset($r['allotedto'])) {
                                    $id = $r['allotedto'];
                                    $qqq = mysqli_query(mysqli_connect("localhost", "root", "password", "ttms"),
