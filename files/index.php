...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h1 align="center" data-scroll-reveal="enter from the bottom after 0.1s">TIME TABLE MANAGEMENT SYSTEM</h1>
        </div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    <!-- Indicators -->
    <ol class="carousel-indicators" style="margin-bottom: 330px">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/001.png" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/791.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/images.jpg" alt="Flower">
        </div>

        <div class="item">
            <img src="assets/img/Computer_lab.webp" alt="Flower">
        </div>
    </div>
</div>
...
<div align="center" STYLE="margin-top: 0px">
    <form data-scroll-reveal="enter from the bottom after 0.2s" action="studentvalidation.php" method="post">
        ...
        <button type="submit" class="btn btn-info btn-lg" style="margin-top: 20px" >Download</button>
    </form>
</div>
<!-- The Modal -->
...
<div id="faculty-sec">
    <div class="container set-pad">
        <div class="row text-center">
            <div class="col-lg-8 col-lg-offset-2 col-md-6 col-sm-8 col-md-offset-2 col-sm-offset-2">
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/IMG-20210829-WA0050.jpg" class="img-rounded"/>
                    <h3 align="center">PRAKHAR SAXENA</h3>
                    <hr/>
                    <h4 align="center">2019BTECHCSE037<br/>Institute of Engineering and Technology</h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">TUSHAR SONI</h3>
                    <hr/>
                    <h4 align="center">2019BTECHCSE055<br/>Institute of Engineering and Technology </h4>

                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/sinhal.png" class="img-rounded"/>
                    <h3 align="center">Dr. AMIT SINHAL</h3>
                    <hr/>
                    <h4 align="center">PROFESSOR<br/>Institute of Engineering and Technology</h4>
    ...
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <div>
                ...
                <h4><strong>Email: </strong>xyz@abc.com</h4>
            </div>
